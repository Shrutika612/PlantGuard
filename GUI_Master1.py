...
# #image2 =image2.resize((false,false), Image.ANTIALIAS)
...
frame_alpr = tk.LabelFrame(root, width=1850, height=1850, bd=5, font=('times', 14, ' bold '),bg="skyblue")
frame_alpr.grid(row=0, column=0)
frame_alpr.place(x=0, y=0)

image2 =Image.open('I6.jpg')
...
background_label.place(x=650, y=25)

lbl = tk.Label(frame_alpr, text="DETECTING LEAF DISEASE ", font=('Times New Roman', 35,' bold '),bg="skyblue",fg="white")
lbl.place(x=350, y=180)

lbl = tk.Label(frame_alpr, text="WITH MACHINE LEARNING", font=('Times New Roman', 35,' bold '),bg="skyblue",fg="white")
...
logo_label1=tk.Label(text='...To develop a system that capable \n To Detect And \n Identify the type of plant leaf disease...',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="#cce6ff", fg="black")
#logo_label=tk.Label(height=500, width=400)
logo_label1.place(x=450,y=500)
