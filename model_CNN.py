...
path1 = 'D:/Ravina data/e-voting finger print model/SOCOFing/training/2'    #path of folder of images    
path2 = 'D:/Ravina data/e-voting finger print model/SOCOFing/testing/2'  #path of folder to save images    
